...
/**
 * This interface represents a generic list. This Interface provide operations on the list such as
 * adding an element to the front, adding an element to the back, adding an element to a particular
 * index, removing the first instance of an object from the list, getting the size of the list,
 * getting the object at a particular index, a map of higher order function that converts one list
 * to another, a method that converts any list of type ListADT to an Immutable list if the list is
 * mutable and can convert the immutable list to a mutable list.We represent the type of data that
 * this will work with a generic parameter T. This is a placeholder for the actual data type.
 */
public interface ListADT<T> {
  ...
  /**
   * This method is used to convert the list to its counterpart.
   *
   * @return a list which is the counterpart of the list.
   */
  ListADT<T> counterPartConverter();
